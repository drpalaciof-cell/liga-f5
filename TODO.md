...
- **EJECUTADA el 2026-08-21** con la aprobación del usuario, después de mostrarle la previsualización. Resultado real: **704 → 695 jugadores**, se sacaron **9 de 6 equipos** (BEER UNITED 1, CITY RECURSOS 4, EL CLAN FC 1, ESTILO F.C. 1, RURAL 55 1, VALENCIA 1). Los otros 28 equipos no se tocaron. Ningún equipo quedó con menos de 5 (el más afectado, CITY RECURSOS, quedó con 21 de 25). Verificado después: **0 jugadores sin seguro quedan en alguna lista**, 9 guardados en `jugadoresSinSeguro`, y los 6 arrays quedaron en 25 filas.
- **Control de tipeos previo**: se buscó si alguno de los 9 DNIs se parecía (distancia 1) a un DNI asegurado del mismo equipo, y si había DNIs asegurados sin fila en la lista. No hubo ninguno → sin falsos positivos por número mal cargado. **Único caso raro avisado al usuario**: `SIGEL, BRIAN` (CITY RECURSOS) tiene DNI de **7 dígitos** (`4606616`), mal cargado; no coincide con ningún asegurado igual.
- **Vuelta atrás (sw v49)**, a pedido del usuario (*"dejame la opción de eventualmente agregar jugador a las listas de buena fe"*): en **Editar plantel** del admin aparece el bloque **"↩️ Quitados por falta de seguro"** leyendo `jugadoresSinSeguro`, con un botón **Reponer** por jugador que lo carga en la primera fila libre (no duplica si ya está, avisa si no quedan lugares). Al guardar, el repuesto deja de figurar como quitado. Agregar jugadores nuevos ya se podía desde ese mismo editor.
